...
To compile the plugin: gcc -g -Wall -fPIC -shared -o xxx_proto_s7comm.so -I /opt/mmt/dpi/include/ -I ../cotp/ s7comm_mmt_plugin.c

To use the plugin: Copy the file xxx_proto_s7comm.so to /opt/mmt/plugins/
*/

#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "s7comm_mmt_plugin.h"
#include "extraction_lib.h"
#include "tcpip/mmt_tcpip.h"
#include <netinet/tcp.h>
#include "../cotp/cotp_mmt_plugin.h"


/*
 * S7COMM data extraction routines
 */
...
#ifndef CORE
int init_proto() {
	return init_s7comm_proto_struct();
}
#endif //CORE
